...
- 0-29%: Extreme Risk. Explicitly tell user NOT to bet direct 1X2 and use Secondary Insights instead. You MUST enforce payload with exactly 4 top Secondary Insights if confidence is 0-29%.
