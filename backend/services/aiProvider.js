...
function buildInsightPrompt(params) {
    ...
    // - 0-29%: Extreme Risk. Explicitly tell user NOT to bet direct 1X2 and to use Secondary Insights.
    //
...
async function generateInsightWithGroq(params) {
    ...
    // - 55-74%: Medium Risk / Moderate Confidence.
    // - 30-54%: High Risk. Advise user to pivot to Secondary Insights.
    // - 0-29%: Extreme Risk. Explicitly tell user NOT to bet direct 1X2 and to use Secondary Insights instead.
    // 
    // Output ONLY valid JSON with this exact structure:
    // {
    //   "market_name": "Home Win",
