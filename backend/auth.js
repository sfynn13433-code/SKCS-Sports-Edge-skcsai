...
const { buildSubscriptionContext } = require('./services/subscriptionTiming');
...
async function login(req, res) {
    try {
        ...
        const latestSubscription = await getLatestSubscriptionByUserId(userId);
    ...
    try {
        ...
        req.user = {
            ...
            ...buildSubscriptionContext({
                profile,
                subscription: await getLatestSubscriptionByUserId(supaUser.id),
                now: new Date()
            })
        };
