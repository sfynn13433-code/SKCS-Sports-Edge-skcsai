...
async function testFixedAIPredictionsEndpoint() {
  ...
  try {
    ...
    const responseData = {
        ...
        updated_at: predictionData.updated_at || predictionData.created_at,
...
// Run the test
testFixedAIPredictionsEndpoint().then(result => {
  console.log('\n=== FIXED TEST RESULT ===');
  ...
  console.log('\n✅ The AI predictions endpoint should now work correctly!');
  console.log('✅ Cricket match IDs will return proper 404 responses instead of 500 errors');
  process.exit(0);
}).catch(error => {
