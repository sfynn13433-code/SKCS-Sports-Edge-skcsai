...
| EAC-001 | Edge Asset Classification and Repository Map | Repository Organization | APPROVED | critical | EAC-001 | Perform a separate EAC-001 classification-foundation closure inspection. Validate schema extension, 29-batch deterministic coverage, manifest/map synchronization, foundation checker pass, and expected strict-closure not-ready state. Do not begin B01 until that inspection returns GO. |
...
| ESA-RR-002 | ESA-RR-002 Implementation Law Seal (Hold) | Governance and Contract Refinement | APPROVED | critical | ESA-RR-002 | Implement ESA-RR-002 Option A provenance-backed runtime inventory reproducibility repair in the sealed checker and add the 16 ESA-RR-T01..T16 contract tests; then regenerate runtime inventory/map only through the approved checker bootstrap and capture closure evidence for separate TESTED promotion. |
